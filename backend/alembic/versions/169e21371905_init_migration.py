...
Revision ID: 169e21371905
Revises: 2eda25d45a47
Create Date: 2025-12-01 17:10:22.431250
...
revision: str = '169e21371905'
down_revision: Union[str, Sequence[str], None] = '2eda25d45a47'
...
def upgrade() -> None:
    ...
    op.drop_table('user_tag_tags')
    op.drop_table('preset_tag_tags')
    op.drop_table('user_tags')
    op.drop_table('tags')
    op.drop_table('activities')
    op.drop_table('users')
    op.drop_table('behave')
    op.drop_table('behave_tag_tags')
    op.drop_table('behave_photos')
    op.drop_table('letter')
    op.drop_table('behave_tags')
    op.drop_table('activity_templates')
    op.drop_table('user_energy_tag_stats')
    op.drop_table('preset_tags')
...
def downgrade() -> None:
    ...
    sa.Column('type', postgresql.ENUM('body', 'mental', name='tagtypeenum'), autoincrement=False, nullable=True),
    ...
    op.create_table('user_energy_tag_stats',
    sa.Column('id', sa.UUID(), autoincrement=False, nullable=False),
    ...
    sa.Column('tag_type', postgresql.ENUM('body', 'mental', name='tagtypeenum'), autoincrement=False, nullable=False),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['tag_id'], ['tags.id'], name=op.f('user_energy_tag_stats_tag_id_fkey')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('user_energy_tag_stats_user_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('user_energy_tag_stats_pkey'))
    )
    op.create_table('activity_templates',
    sa.Column('id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('title', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('description', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('duration_minutes', sa.TEXT(), autoincrement=False, nullable=True),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['energy_level_id'], ['energy_levels.id'], name=op.f('activity_templates_energy_level_id_fkey')),
    ...
    sa.ForeignKeyConstraint(['behave_id'], ['behave.id'], name='behave_tags_behave_id_fkey'),
    sa.ForeignKeyConstraint(['tag_id'], ['tags.id'], name='behave_tags_tag_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='behave_tags_pkey'),
    postgresql_ignore_search_path=False
    )
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('before_energy', postgresql.ENUM('level_0', 'level_1', 'level_2', 'level_3', 'level_4', 'level_5', 'level_6', 'level_7', 'level_8', 'level_9', 'level_10', name='energylevelenum'), server_default=sa.text("'level_0'::energylevelenum"), autoincrement=False, nullable=False),
    sa.Column('after_energy', postgresql.ENUM('level_0', 'level_1', 'level_2', 'level_3', 'level_4', 'level_5', 'level_6', 'level_7', 'level_8', 'level_9', 'level_10', name='energylevelenum'), autoincrement=False, nullable=True),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['energy_level_id'], ['energy_levels.id'], name=op.f('activities_energy_level_id_fkey')),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name=op.f('energy_levels_pkey'))
    )
    # ### end Alembic commands ###
